  ...
  factory AppThemeData({
    ...
    required AppColorScheme colorScheme,
      ...
      AppThemeData.raw(
          ...
          textThemeT2:
              AppTextTheme.create(colorScheme.textColor.withOpacity(0.6)),
          textThemeT3:
...
class AppTextTheme {
  ...
  factory AppTextTheme.create(Color color) {
    final fontAcmeRegular = FontApp.acmeRegular.name;
    final fontPoppinMedium = FontApp.poppinMedium.name;
    final fontPoppinRegular = FontApp.poppinRegular.name;
    final fontPoppinThin = FontApp.poppinThin.name;

    return AppTextTheme(
      bigTitle: TextStyle(
        fontFamily: fontPoppinMedium,
